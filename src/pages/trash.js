    ...
    <div className="flex flex-col h-full w-full">
      ...
      <main className="flex-grow overflow-auto p-4 sm:p-6 lg:p-8">
        ...
        {!loading && !error && trashedFiles.length === 0 && (
          <div className="group-data-[state=expanded]/sidebar-wrapper:md:-ml-16 md:ml-96 h-full flex flex-col items-center justify-center text-center text-muted-foreground transition-all duration-200 ease-in-out">

...
function UploadPage() {
  ...
  return (
    <div className="flex flex-col h-full w-full">
         ...
         <main className="flex-grow overflow-auto p-4 sm:p-6 lg:p-8 flex justify-center items-center group-data-[state=expanded]/sidebar-wrapper:md:ml-36 md:ml-72 transition-all duration-200 ease-in-out">

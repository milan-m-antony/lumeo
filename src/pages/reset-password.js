...
import { Lock, Eye, EyeOff, ArrowLeft, Save, CheckCircle, AlertCircle, Loader2, Mail, Hash } from 'lucide-react';
            ...
            >
                <div className="relative bg-black/40 backdrop-blur-xl rounded-2xl p-6 border border-white/[0.05] shadow-2xl overflow-hidden">
                    <div className="text-center space-y-2 mb-6">
                        ...
                        <p className="text-white/60 text-xs">Enter the token from your email and a new password.</p>
                    </div>
                    ...
                    {success ? (
                        ...
                        <form onSubmit={handleSubmit} className="space-y-4">
                            ...
                            <div className="relative flex items-center">
                                <Hash className="absolute left-3 w-4 h-4 text-white/40" />
                                <Input
                                    type="text"
